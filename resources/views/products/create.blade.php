...
<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 py-10">
    <div class="bg-white shadow-lg rounded-2xl w-full max-w-4xl p-8">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-2xl font-bold text-indigo-700">🛒 Add New Product (Size-wise Stock & Price)</h2>
        ...
        <form action="{{ route('products.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <textarea name="detail" rows="4"
                          ...
                          class="w-full border-gray-300 focus:ring-indigo-500 focus:border-indigo-500 rounded-lg text-sm px-4 py-2">{{ old('detail') }}</textarea>
            </div>
            ...
            <div>
                    ...
                    <table class="min-w-full border border-gray-200 text-sm text-gray-700">
                        ...
                        <tbody>
                            ...
                            <tr class="border-b">
                                ...
                                <td class="px-3 py-2">{{ $size->label ?? $size->name }}</td>
                                <td class="px-3 py-2 text-center">
                                    <input type="number" name="sizes[{{ $size->id }}][qty]" min="0" value="0"
                ...
                <p class="text-xs text-gray-500 mt-2">✔️ Tick sizes you sell and enter stock + price per size.</p>
            </div>
