...
<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 py-10">
    <div class="bg-white shadow-lg rounded-2xl w-full max-w-3xl p-8">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-2xl font-bold text-indigo-700">✏️ Edit Product</h2>
        ...
        <form action="{{ route('products.update', $product->id) }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <textarea name="detail" rows="4"
                          ...
                          class="w-full border-gray-300 focus:ring-indigo-500 focus:border-indigo-500 rounded-lg shadow-sm text-sm px-4 py-2">{{ old('detail', $product->detail) }}</textarea>
            </div>
