...
<div class="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-10 px-4">
    <div class="max-w-4xl mx-auto bg-white shadow-lg rounded-2xl p-6">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-center mb-6">
            <h2 class="text-2xl font-bold text-indigo-700 mb-4 sm:mb-0">📂 Categories</h2>
                ...
                <tbody class="divide-y divide-gray-100 bg-white">
                    @foreach ($categories as $category)
                        <tr class="hover:bg-indigo-50 transition">
                            ...
                            <td class="px-4 py-3 text-sm text-gray-800 font-medium">{{ $category->name }}</td>
                            <td class="px-4 py-3 text-sm text-gray-600">{{ Str::limit($category->description, 60) }}</td>
